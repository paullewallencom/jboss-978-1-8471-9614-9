...
// Generated Jan 31, 2009 10:07:56 PM by Hibernate Tools 3.2.2.GA
...
public class ParentHome {
	...
	public Parent merge(Parent detachedInstance) {
		...
		try {
			Parent result = (Parent) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Parent findById(int id) {
		...
		try {
			Parent instance = (Parent) sessionFactory.getCurrentSession().get(
					"mappings_re.Parent", id);
			if (instance == null) {
	...
	public List<Parent> findByExample(Parent instance) {
		log.debug("finding Parent instance by example");
		try {
			List<Parent> results = (List<Parent>) sessionFactory
					.getCurrentSession().createCriteria("mappings_re.Parent")
